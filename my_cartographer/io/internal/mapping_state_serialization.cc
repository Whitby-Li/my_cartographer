...
namespace my_cartographer
{
  namespace io
  {
    ...
    namespace
    {
      using map::MapById;
      using map::NodeId;
      using map::PoseGraphInterface;
      using map::SubmapId;
      using map::TrajectoryNode;
      using map::proto::SerializedData;

      map::proto::AllTrajectoryBuilderOptions
      ...
      {
        map::proto::AllTrajectoryBuilderOptions all_options_proto;
      ...
      map::proto::SerializationHeader CreateHeader()
      {
      ...
      SerializedData SerializePoseGraph(const map::PoseGraph &pose_graph,
