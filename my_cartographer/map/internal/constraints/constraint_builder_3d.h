...
#ifndef MY_CARTOGRAPHER_MAP_INTERNAL_CONSTRAINTS_CONSTRAINT_BUILDER_3D_H_
#define MY_CARTOGRAPHER_MAP_INTERNAL_CONSTRAINTS_CONSTRAINT_BUILDER_3D_H_
...
namespace my_cartographer
{
  namespace map
  {
    namespace constraints
    {
      ...
      {
      public:
        using Constraint = map::PoseGraphInterface::Constraint;
...
#endif // MY_CARTOGRAPHER_MAP_INTERNAL_CONSTRAINTS_CONSTRAINT_BUILDER_3D_H_