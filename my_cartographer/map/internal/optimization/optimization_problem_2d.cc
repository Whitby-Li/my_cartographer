...
#include "my_cartographer/map/internal/optimization/cost_functions/landmark_cost_function_2d.hpp"
#include "my_cartographer/map/internal/optimization/cost_functions/spa_cost_function_2d.h"
...
namespace my_cartographer
{
  namespace map
  {
    namespace optimization
    {
      ...
      namespace 
      {
        using my_cartographer::map::optimization::CeresPose;
        using LandmarkNode = my_cartographer::map::PoseGraphInterface::LandmarkNode;
        using TrajectoryData = my_cartographer::map::PoseGraphInterface::TrajectoryData;
