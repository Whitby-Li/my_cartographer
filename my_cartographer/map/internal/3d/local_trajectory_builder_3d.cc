  ...
  namespace map
  {
        ...
        const sensor::PointCloud &high_resolution_point_cloud_in_tracking)
    {
      ...
      ceres_scan_matcher_->Match(
          ...
          initial_ceres_pose, {{&high_resolution_point_cloud_in_tracking, &matching_submap->high_resolution_hybrid_grid(), high_resolution_intensity_hybrid_grid}, {&low_resolution_point_cloud_in_tracking, &matching_submap->low_resolution_hybrid_grid(),
    ...
    void LocalTrajectoryBuilder3D::AddImuData(const sensor::ImuData &imu_data)
    {
      ...
      extrapolator_ = PoseExtrapolatorInterface::CreateWithImuData(
