...
#ifndef MY_CARTOGRAPHER_SENSOR_INTERNAL_PROBABILITY_VALUES_H_
#define MY_CARTOGRAPHER_SENSOR_INTERNAL_PROBABILITY_VALUES_H_
...
#endif // MY_CARTOGRAPHER_SENSOR_INTERNAL_PROBABILITY_VALUES_H_
