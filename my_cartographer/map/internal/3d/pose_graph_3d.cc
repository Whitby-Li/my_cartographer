  ...
  namespace map
  {
        ...
        const constraints::ConstraintBuilder3D::Result &result)
    {
...

      {
        ...
        {
          if (constraint.tag == map::PoseGraph::Constraint::INTRA_SUBMAP)
          {
            continue;
          }
