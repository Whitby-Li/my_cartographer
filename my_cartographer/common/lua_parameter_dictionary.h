...
#ifndef MY_CARTOGRAPHER_COMMON_LUA_PARAMETER_DICTIONARY_H_
#define MY_CARTOGRAPHER_COMMON_LUA_PARAMETER_DICTIONARY_H_

#include "my_cartographer/common/lua.h"
...
#endif // MY_CARTOGRAPHER_COMMON_LUA_PARAMETER_DICTIONARY_H_