...
#include "my_cartographer/map/internal/3d/imu_integration.hpp"
#include "my_cartographer/map/internal/3d/rotation_parameterization.hpp"
#include "my_cartographer/map/internal/optimization/ceres_pose.h"
#include "my_cartographer/map/internal/optimization/cost_functions/acceleration_cost_function_3d.hpp"
#include "my_cartographer/map/internal/optimization/cost_functions/landmark_cost_function_3d.hpp"
#include "my_cartographer/map/internal/optimization/cost_functions/rotation_cost_function_3d.hpp"
#include "my_cartographer/map/internal/optimization/cost_functions/spa_cost_function_3d.hpp"
  ...
  namespace map
  {
    namespace optimization
    {
      namespace
      {
        ...
        using TrajectoryData = PoseGraphInterface::TrajectoryData;
        ...
        for (auto node_it = node_data_.begin(); node_it != node_data_.end();)
        {
          ...
          for (; node_it != trajectory_end; ++node_it)
          {
            ...
            problem.AddResidualBlock(
                ...
                options_.fixed_frame_pose_use_tolerant_loss() ? new ceres::TolerantLoss(
