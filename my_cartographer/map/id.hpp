...
#ifndef MY_CARTOGRAPHER_MAP_ID_HPP
#define MY_CARTOGRAPHER_MAP_ID_HPP
...
namespace my_cartographer
{
  namespace map
  {
    ...
    // Reminiscent of std::map, but indexed by 'IdType' which can be 'NodeId' or 'SubmapId'.
    // Note: This container will only ever contain non-empty trajectoies. Trimming the last remaining node of a trajectory drops the trajectory.
...
#endif // MY_CARTOGRAPHER_MAP_ID_HPP