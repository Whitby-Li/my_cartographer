...
namespace my_cartographer
{
  namespace map
  {
    ...
    namespace
    {
      ...
      class GlobalTrajectoryBuilder : public map::TrajectoryBuilderInterface
      {
      public:
        ...
        void AddLocalSlamResultData(std::unique_ptr<map::LocalSlamResultData>
    ...
    std::unique_ptr<TrajectoryBuilderInterface> CreateGlobalTrajectoryBuilder2D(
        ...
        const int trajectory_id, map::PoseGraph2D *const pose_graph,
        const TrajectoryBuilderInterface::LocalSlamResultCallback &
            local_slam_result_callback,
        const absl::optional<MotionFilter> &pose_graph_odometry_motion_filter)
    {
      return absl::make_unique<
          GlobalTrajectoryBuilder<LocalTrajectoryBuilder2D, map::PoseGraph2D>>(
    ...
    std::unique_ptr<TrajectoryBuilderInterface> CreateGlobalTrajectoryBuilder3D(
        ...
        const int trajectory_id, map::PoseGraph3D *const pose_graph,
        const TrajectoryBuilderInterface::LocalSlamResultCallback &
            local_slam_result_callback,
        const absl::optional<MotionFilter> &pose_graph_odometry_motion_filter)
    {
      return absl::make_unique<
          GlobalTrajectoryBuilder<LocalTrajectoryBuilder3D, map::PoseGraph3D>>(
          std::move(local_trajectory_builder), trajectory_id, pose_graph,
          local_slam_result_callback, pose_graph_odometry_motion_filter);
    }
